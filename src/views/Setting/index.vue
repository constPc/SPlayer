    ...
    },
    {
      ...
      value: 'dark',
        ...
        <n-card class="set-item">
          ...
          <n-switch v-model:value="themeAuto" :round="false" @update:value="(val) => {
    ...
    },
    {
      ...
      <div v-if="checkPlatform.electron()" class="set-type">
        ...
        <n-card class="set-item">
          ...
          <n-select v-model:value="closeType" :disabled="closeTip" :options="[
    {
      label: '最小化到任务栏',
      value: 'hide',
    },
    {
      ...
      value: 'close',
        ...
        <n-card class="set-item">
          ...
          <n-switch v-model:value="showTaskbarProgress" :round="false" @update:value="closeTaskbarProgress" />
        </n-card>
      </div>
